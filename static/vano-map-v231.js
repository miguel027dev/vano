...
function makeUserMarker(){
  /* TWA/Chrome can restore a previous Mapbox DOM tree from bfcache. Remove any
     orphaned legacy puck before creating the single live user marker. */
  document.querySelectorAll('.vano-user-puck-v230,.user-marker.vano-uploaded-user').forEach(node=>{
