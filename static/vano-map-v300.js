...
async function installRuntimeLayers(){
  ...
  ensureLayer({id:'nav-turn-core',type:'line',source:'nav-turn',layout:{'line-cap':'round','line-join':'round'},paint:{'line-color':'#FFF7ED','line-width':['interpolate',['linear'],['zoom'],12,2.2,16,3.2,20,4.2],'line-opacity':.96}},routeBefore);
  ...
  ensureLayer({id:'alerts-cluster',type:'circle',source:'alerts',filter:['has','point_count'],maxzoom:14.5,paint:{'circle-radius':['step',['get','point_count'],18,4,22,8,26,16,30],'circle-color':['step',['get','point_count'],'#2d3140',4,'#FF3D00',8,'#ea580c',16,'#dc2626'],'circle-stroke-color':'rgba(255,255,255,.94)','circle-stroke-width':2,'circle-opacity':.96}},routeBefore);
  ...
  ensureLayer({id:'alerts-marker-halo',type:'circle',source:'alerts',filter:unclustered,minzoom:10.5,paint:{'circle-radius':['interpolate',['linear'],['zoom'],10.5,10,16,16],'circle-color':['match',['get','category'],'robbery','#ff3348','harassment','#FF3D00','poor_lighting','#68758A','accident','#ff653d','traffic','#ee8a35','road_block','#ff3348','blitz','#ff8a2b','speed_camera','#ff9b32','road_hazard','#d47732','pothole','#d47732','stopped_vehicle','#e3903d','object_on_road','#e3903d','broken_signal','#ffb13b','flood','#4587d9','construction','#e09a37','crowd','#FF3D00','#7d8290'],'circle-opacity':.14,'circle-blur':.48}},routeBefore);
